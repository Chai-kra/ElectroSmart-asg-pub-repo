...
public class ApplianceManager {
    ...
    public void processSale(Scanner scanner, CustomerManager customerManager, StaffManager staffManager, Staff staff)
        ...
        while (addingItems) {
            ...
            if (!scanner.nextLine().equalsIgnoreCase("Y")) addingItems = false;
        }
    ...
    public void extendApplianceWarranty(Scanner scanner, Staff staff) throws InvalidWarrantyExtensionException {
        ...
        System.out.println("Warranty extended successfully by " + extraMonths + " months.");
    }
