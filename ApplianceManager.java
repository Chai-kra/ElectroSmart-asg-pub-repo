...
public class ApplianceManager {
     ...
     */
    // [Q&A #1] "How do you achieve non-duplicating IDs if one was previously deleted?"
    // Generate-and-check loop: format a candidate ID, then verify it's unused via
    // findApplianceByID() before returning. nextApplianceNumber never resets on
    // delete, so a removed ID is simply never reissued.
